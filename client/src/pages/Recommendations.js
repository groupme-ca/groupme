...
class RecommendationPage extends React.Component {
	constructor(props) {
		...
		this.state = {
			...
			interestCurrPage: 1,
			interestNumPages:
				recommendations.hobbies.length < 4
					? 1
					: 1 + Math.ceil(recommendations.hobbies.length / 4),
			coursesCurrPage: 1,
			courseNumPages:
				recommendations.courses.length < 4
					? 1
	...
	async generateRecommendations() {
		...
		this.setState({
			...
			interestCurrPage: 1,
			interestNumPages:
				recommendHobbies.length > 4 ? recommendHobbies.length - 3 : 1,
			coursesCurrPage: 1,
			courseNumPages:
				recommendCourses.length > 4 ? recommendCourses.length - 3 : 1,
		...
		return (
			<div className="page-container">
				...
				<div className="page-content">
					...
					/>
					<h1 className="header">Find people to study with</h1>
					<div id="online-count">
					...
					<div className="filter-section">
						<input placeholder="Search" className="filter-input" />
					</div>
			...
			<div className="page-container">
				...
				<div className="page-content">
					...
					<div class="filter-section">
						<input placeholder="Search" class="filter-input" />
					</div>
					<p className="select-header"> Filter By: </p>
					<div className="filter-section">
						<div>
...
<<<<<<< HEAD
export default connect(mapStateToProps, { getUsers, getChats })(
	RecommendationPage
);
=======
<<<<<<< HEAD
...
=======
export default connect(mapStateToProps, { getChats, getUsers })(
	RecommendationPage
);
>>>>>>> get rid of unnecessary axios file
>>>>>>> get rid of unnecessary axios file
